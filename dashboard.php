...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><img src="img/logo.png" alt="logo" style="width:70px;height:50px;"></a>
    <?php
	...
	?>			 
		...
		?>		   
			...
			<div class="tab-pane fade show" id="CompareMenu" role="tabpanel" aria-labelledby="CompareMenu-tab">
				...
				<td>
				<div class="form-group">
                      <label for="resturant1">Resturant 1</label>
                      <select id="fldvendor" name="fldvendor" class="form-control"  title="Select First Resturant" required="required">
						<?php
              ...
              ?>
				...
				<div class="form-group">
                      <label for="resturant2">Resturant 2</label>
                      <select id="fldvendor_2" name="fldvendor_2" class="form-control"  title="Select Second Resturant" required="required" >
						<?php
                            $Resturant_1 = mysqli_query($con,"SELECT * FROM `tblvendor`");
                            if(mysqli_num_rows($Resturant_1)>0){
                                while($row = mysqli_fetch_array($Resturant_1)){
